...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__graph_node_editor_graph_node_editor_component__ = __webpack_require__("../../../../../src/app/graph-node-editor/graph-node-editor.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_19__graph_node_editor_graph_node_editor_component__["a" /* GraphNodeEditorComponent */],
            ],
            imports: [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__custom_view_descriptor__ = __webpack_require__("../../../../../src/app/custom-view-descriptor.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__node_graph_view_descriptor__ = __webpack_require__("../../../../../src/app/node-graph-view-descriptor.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var EditorComponent = (function () {
    ...
    EditorComponent.prototype.isGraphView = function (obj) {
        return (obj.type == __WEBPACK_IMPORTED_MODULE_6__node_graph_view_descriptor__["a" /* NodeGraphViewDescriptor */].NODEGRAPH_TYPE);
    };
...
/***/ "../../../../../src/app/graph-node-editor/graph-node-editor.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, ".links line {\n  stroke: #fff;\n  stroke-opacity: 1;\n}\n \n.nodes circle {\n  stroke: #fff;\n  stroke-width: 1.5px;\n}", ""]);
...
/***/ "../../../../../src/app/graph-node-editor/graph-node-editor.component.html":
/***/ (function(module, exports) {

module.exports = "HI<svg width=\"600\" height=\"300\" class=\"mysvg\" > </svg>"

/***/ }),

/***/ "../../../../../src/app/graph-node-editor/graph-node-editor.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return GraphNodeEditorComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_edit_service__ = __webpack_require__("../../../../../src/app/services/edit.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__file_details__ = __webpack_require__("../../../../../src/app/file-details.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__abstract_syntax_tree__ = __webpack_require__("../../../../../src/app/abstract-syntax-tree.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__node_graph_view_descriptor__ = __webpack_require__("../../../../../src/app/node-graph-view-descriptor.ts");
...
var GraphNodeEditorComponent = (function () {
    function GraphNodeEditorComponent(editService) {
        this.editService = editService;
        this.refresh = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["v" /* EventEmitter */]();
        this.radius = 10;
    }
    GraphNodeEditorComponent.prototype.ngOnInit = function () {
    };
    // storedNodes = [
    ...
    // 	{"source": "2", "target":"1"},
    // ]
    GraphNodeEditorComponent.prototype.ngAfterContentInit = function () {
        //Initialise relevant attributes
        var svg = __WEBPACK_IMPORTED_MODULE_5_d3__["g" /* select */]("svg"), width = +svg.attr("width"), height = +svg.attr("height"), nodes = this.nodeViewDescriptor.vertices, links = this.nodeViewDescriptor.edges;
        var selectedNode = null;
        var selectedLink = null;
        //init simulation itself and apply forces
        //charge_force repels other nodes
        //center_force forces towards centre of svg
        var simulation = __WEBPACK_IMPORTED_MODULE_5_d3__["e" /* forceSimulation */]()
            .nodes(this.nodeViewDescriptor.vertices)
            .force("charge_force", __WEBPACK_IMPORTED_MODULE_5_d3__["d" /* forceManyBody */]())
            .force("center_force", __WEBPACK_IMPORTED_MODULE_5_d3__["b" /* forceCenter */](width / 2, height / 2));
        //Create the link force 
        //id determines which attribute we take from nodes
        var link_force = __WEBPACK_IMPORTED_MODULE_5_d3__["c" /* forceLink */](links)
        ...
        function clickNode(d, i) {
            if (selectedNode == null) {
                ...
                if (lin.length == 0) {
                    ...
                    that.editService.addReference(that.projId, that.fileDetails, that.nodeViewDescriptor.nodeId, "edges", "Edge")
                        ...
                        that.editService.addCrossReference(that.projId, that.fileDetails, a.nodeId, "source", newLink.source.nodeId).subscribe(function (b) {
                            that.editService.addCrossReference(that.projId, that.fileDetails, a.nodeId, "dest", newLink.target.nodeId).subscribe(function (c) {
                                links.push(newLink);
                                selectedNode = null;
                                update();
                            });
            ...
            __WEBPACK_IMPORTED_MODULE_5_d3__["a" /* event */].stopPropagation();
        }
        var that = this;
        function clickCanvas() {
            if (selectedNode == null && selectedLink == null) {
                ...
                if (newNodeName !== null && newNodeName !== "") {
                    var point = __WEBPACK_IMPORTED_MODULE_5_d3__["f" /* mouse */](this);
                    ...
                    that.editService.addReference(that.projId, that.fileDetails, that.nodeViewDescriptor.nodeId, "vertices", "Vertex")
                        ...
                        that.editService.validateAttribute(that.projId, that.fileDetails, a.nodeId, "name", newNodeName).subscribe(function (a) { return null; });
                        that.editService.updateAttribute(that.projId, that.fileDetails, a.nodeId, "name", newNodeName).subscribe(function (a) { return null; });
                        nodes.push(newNode);
                        update();
                    });
                }
        ...
        function rightClickLink(d, i) {
            var _this = this;
            __WEBPACK_IMPORTED_MODULE_5_d3__["a" /* event */].preventDefault();
            that.editService.removeReference(that.projId, that.fileDetails, that.nodeViewDescriptor.nodeId, d.nodeId, "edges")
                .subscribe(function (a) { that.nodeAST.removeChild(d.nodeId); _this.refreshView(); });
            links.splice(i, 1);
            update();
        }
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Input */])(),
        __metadata("design:type", String)
    ], GraphNodeEditorComponent.prototype, "projId", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Input */])(),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_2__file_details__["a" /* FileDetails */])
    ], GraphNodeEditorComponent.prototype, "fileDetails", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Input */])(),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_4__node_graph_view_descriptor__["a" /* NodeGraphViewDescriptor */])
    ], GraphNodeEditorComponent.prototype, "nodeViewDescriptor", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Input */])(),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_3__abstract_syntax_tree__["a" /* AbstractSyntaxTree */])
    ], GraphNodeEditorComponent.prototype, "nodeAST", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["P" /* Output */])(),
        __metadata("design:type", Object)
    ], GraphNodeEditorComponent.prototype, "refresh", void 0);
    GraphNodeEditorComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'graph-node-editor',
            template: __webpack_require__("../../../../../src/app/graph-node-editor/graph-node-editor.component.html"),
            styles: [__webpack_require__("../../../../../src/app/graph-node-editor/graph-node-editor.component.css")],
            encapsulation: __WEBPACK_IMPORTED_MODULE_0__angular_core__["_10" /* ViewEncapsulation */].None
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_edit_service__["a" /* EditService */]])
    ], GraphNodeEditorComponent);
    return GraphNodeEditorComponent;
}());
...
/***/ "../../../../../src/app/node-graph-view-descriptor.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return NodeGraphViewDescriptor; });
/* unused harmony export Vertex */
/* unused harmony export Edge */
var NodeGraphViewDescriptor = (function () {
    function NodeGraphViewDescriptor() {
    }
    NodeGraphViewDescriptor.NODEGRAPH_TYPE = "NodeGraph";
    return NodeGraphViewDescriptor;
}());
