 ...
 */
package ox.xtext.peweb.arithmetic.ide.contentassist.antlr;
...
import ox.xtext.peweb.arithmetic.ide.contentassist.antlr.internal.InternalArithmeticParser;
...
public class ArithmeticParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ArithmeticGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSumExpressionAccess().getIndexVariableAssignment_1(), "rule__SumExpression__IndexVariableAssignment_1");
			builder.put(grammarAccess.getSumExpressionAccess().getLowerAssignment_3(), "rule__SumExpression__LowerAssignment_3");
			builder.put(grammarAccess.getSumExpressionAccess().getUpperAssignment_5(), "rule__SumExpression__UpperAssignment_5");
			builder.put(grammarAccess.getSumExpressionAccess().getExprAssignment_7(), "rule__SumExpression__ExprAssignment_7");
			builder.put(grammarAccess.getPrimaryExpressionAccess().getValueAssignment_2_1(), "rule__PrimaryExpression__ValueAssignment_2_1");
			builder.put(grammarAccess.getPrimaryExpressionAccess().getFuncAssignment_3_1(), "rule__PrimaryExpression__FuncAssignment_3_1");
		}
	}
